...
# The model represents two planar stratigraphic units (blue and red)
# dipping towards the south above an unspecified basement (yellow). The
# map has been georeferenced with QGIS. The stratigraphic boundaries were
