...
# data. The area is 3727 m wide (W-E extent) and 2596 m high (N-S extent).
# The vertical model extent varies between 2400 m and 2475 m. The model
# represents a coal seam that is outcropping at the surface and was
# encountered in boreholes at depth.
# 
...
img = mpimg.imread('../../docs/getting_started/images/cover_example21.png')
...
# %% 
file_path = 'data/example21/'
gg.download_gemgis_data.download_tutorial_data(filename="example21_coal_seam_mining.zip", dirpath=file_path)
...
import matplotlib.pyplot as plt
import matplotlib.image as mpimg
img = mpimg.imread('../../docs/getting_started/images/dem_example21.png')
plt.figure(figsize=(10, 10))
imgplot = plt.imshow(img)
plt.axis('off')
plt.tight_layout()
...
import matplotlib.pyplot as plt
import matplotlib.image as mpimg
img = mpimg.imread('../../docs/getting_started/images/interfaces_example21.png')
plt.figure(figsize=(10, 10))
imgplot = plt.imshow(img)
plt.axis('off')
plt.tight_layout()
...
import matplotlib.pyplot as plt
import matplotlib.image as mpimg
img = mpimg.imread('../../docs/getting_started/images/orientations_example21.png')
plt.figure(figsize=(10, 10))
imgplot = plt.imshow(img)
plt.axis('off')
plt.tight_layout()
