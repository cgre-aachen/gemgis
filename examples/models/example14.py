...
# data. The area is 2973 m wide (W-E extent) and 3698 m high (N-S extent).
# The vertical model extent varies between 0 m and 1000 m. This example
# represents a classic “three-point-problem” of planar dipping layers
# (blue and purple) above an unspecified basement. The interface points
# were not recorded at the surface but rather in boreholes at depth.
# 
...
img = mpimg.imread('../../docs/getting_started/images/cover_example14.png')
...
import matplotlib.pyplot as plt
import matplotlib.image as mpimg
img = mpimg.imread('../../docs/getting_started/images/dem_example14.png')
plt.figure(figsize=(10, 10))
imgplot = plt.imshow(img)
plt.axis('off')
plt.tight_layout()
...
# points with the respective height value as given by the contour lines
# and the respective formation.
# 

# %% 
import matplotlib.pyplot as plt
import matplotlib.image as mpimg
img = mpimg.imread('../../docs/getting_started/images/interfaces_example14.png')
plt.figure(figsize=(10, 10))
imgplot = plt.imshow(img)
plt.axis('off')
plt.tight_layout()
...
import matplotlib.pyplot as plt
import matplotlib.image as mpimg
img = mpimg.imread('../../docs/getting_started/images/orientations_example14.png')
plt.figure(figsize=(10, 10))
imgplot = plt.imshow(img)
plt.axis('off')
plt.tight_layout()
