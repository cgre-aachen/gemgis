...
# data. The area is 3968 m wide (W-E extent) and 2731 m high (N-S extent).
# The model represents folded and faulted layers (red, yellow, green) as
# well as layers separated by an unconfirmity (light red to light green)
# above an unspecified basement (light blue). The vertical model extent
# varies between 0 m and 1000 m.
# 
...
img = mpimg.imread('../../docs/getting_started/images/cover_example16.png')
...
import matplotlib.pyplot as plt
import matplotlib.image as mpimg
img = mpimg.imread('../../docs/getting_started/images/dem_example16.png')
plt.figure(figsize=(10, 10))
imgplot = plt.imshow(img)
plt.axis('off')
plt.tight_layout()
...
import matplotlib.pyplot as plt
import matplotlib.image as mpimg
img = mpimg.imread('../../docs/getting_started/images/interfaces_example16.png')
plt.figure(figsize=(10, 10))
imgplot = plt.imshow(img)
plt.axis('off')
plt.tight_layout()
...
import matplotlib.pyplot as plt
import matplotlib.image as mpimg
img = mpimg.imread('../../docs/getting_started/images/orientations_example16.png')
plt.figure(figsize=(10, 10))
imgplot = plt.imshow(img)
plt.axis('off')
plt.tight_layout()
