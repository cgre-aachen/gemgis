...
# data. The area is 1187 m wide (W-E extent) and 1400 m high (N-S extent).
# The vertical model extents varies between 0 m and 600 m. The model
# represents two planar stratigraphic units (blue and red) dipping towards
# the western and southwestern directions above an unspecified basement
...
# as well and were used to calculate orientations for the ``GemPy`` model.
# These will be loaded into the model directly. The contour lines were
# also digitized and will be interpolated with ``GemGIS`` to create a
